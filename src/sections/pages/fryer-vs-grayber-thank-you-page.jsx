...
import { HD28_PAID_FOR } from '@/sections/pages/fryer-vs-grayber-page'

const GUIDE_URL = '/downloads/hd28-voters-guide.pdf'
const GUIDE_FILENAME = 'HD28-Voter-Guide-Randall-Fryer-vs-Dacia-Grayber.pdf'
const FUNNEL = 'hd28_voter_guide'

const VIEW_PARAMS = {
  content_category: 'voter_info',
  content_name: 'hd28_thank_you',
}
...
export default function HD28ThankYouPage() {
  ...
  const triggerDownload = useCallback(() => {
    ...
    try {
      ...
      trackDownload({ form_name: FUNNEL, file: 'hd28-voters-guide.pdf' })
    } catch {
    ...
    <>
      ...
      <section className="text-foreground relative isolate overflow-x-clip pt-28 pb-20 sm:pt-32 sm:pb-24">
        ...
        <div className="relative mx-auto flex w-full max-w-3xl flex-col items-center px-5 text-center sm:px-8 lg:px-12">
          ...
          >
            Oregon House District 28 • 2026
          </m.div>

          <SplitText
            as="h1"
            by="word"
            text="Your HD28 Voter Guide Is Ready."
          ...
          >
            Thanks for requesting the 2026 Oregon House District 28 Voter Guide: Randall Fryer vs.
            Dacia Grayber.
          </m.p>
          <m.p
            initial={{ opacity: 0, y: 14 }}
          ...
          >
            <Button
              ...
              size="xl"
              variant="primary"
              data-testid="download-hd28-guide"
          ...
          >
            Review the record. Compare the priorities. Decide which approach you want representing
            HD28 in Salem.
          </m.p>
        </div>
      </section>
