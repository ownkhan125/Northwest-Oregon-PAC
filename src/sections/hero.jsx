      ...
      >
        <div className="lg:col-span-8">
          ...
          >
            ...
            Nonpartisan · Filing #{pac.filingNumber} · 2026
          </m.div>
          ...
          <div className="font-display text-foreground text-[12vw] leading-[0.95] font-medium tracking-tight sm:text-6xl md:text-7xl lg:text-[86px]">
            <SplitText as="span" text="Northwest" className="block" delay={0.2} inView={false} />
            <SplitText as="span" text="Oregon" className="block" delay={0.4} inView={false} />
            <SplitText
              as="span"
              text="PAC."
              className="block"
          ...
          <m.p
            ...
            className="text-foreground/80 mt-8 max-w-2xl text-base sm:text-lg md:text-xl"
          >
            {pac.tagline}
          </m.p>
        ...
        <div className="relative lg:col-span-4">
          ...
          >
            ...
            <div className="border-primary/20 bg-surface-alt relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-[2rem] border p-10 text-center">
              <div className="text-muted font-mono text-[10px] tracking-[0.35em] uppercase">
                Est. 2025
              </div>
              <div className="font-display text-primary mt-6 text-4xl leading-tight font-medium sm:text-5xl">
                Northwest
                <br />
                Oregon
                <br />
              ...
              <p className="text-foreground/75 mt-6 max-w-[240px] text-sm">
                Prosperity · Accountability · Opportunity
              </p>
              <div className="border-primary/25 mt-8 rounded-full border px-4 py-1.5">
