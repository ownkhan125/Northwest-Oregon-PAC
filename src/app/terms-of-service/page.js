...
const sections = [
  {
    ...
    body: [
      'Northwest Oregon PAC provides information, updates, and engagement opportunities related to the work of a political action committee — including PAC updates, event invitations, and donation processing.',
    ],
  },
  {
  ...
  },
  {
    heading: 'Contact',
    body: [
      `Questions about these Terms? Email ${pac.contact.generalEmail}, call ${pac.contact.phone}, or write to Northwest Oregon PAC, ${pac.contact.mailingAddress}. Filing #${pac.filingNumber}, regulated by the ${pac.regulator}.`,
    ],
  },
]
