...
export const A2P_SMS_UPDATES_LABEL =
  'I agree to receive informational text messages from Northwest Oregon PAC, including campaign updates, candidate information, and policy updates. Message frequency varies. Message & data rates may apply. Reply STOP to opt out or HELP for help.'

export const A2P_SMS_PROMO_LABEL =
  'I agree to receive promotional text messages from Northwest Oregon PAC, including fundraising requests and donation drives. Message frequency varies. Message & data rates may apply. Reply STOP to opt out or HELP for help.'
