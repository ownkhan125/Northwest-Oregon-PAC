// Renders guide.html → public/downloads/hd27-voters-guide.pdf.
// Usage: node lead-magnets/hd27/render.mjs [--shots <dir>]
...
const out = path.join(root, 'public/downloads/hd27-voters-guide.pdf')
