// Renders guide.html → public/downloads/hd28-voters-guide.pdf.
// Usage: node lead-magnets/hd28/render.mjs [--shots <dir>]
// Playwright is resolved from the repo's playwright skill install.
...
const out = path.join(root, 'public/downloads/hd28-voters-guide.pdf')
...
// Fail loudly if any page's content spills past its fixed 11in frame.
