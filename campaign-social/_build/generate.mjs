...
<style>
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .eyebrow { display:inline-flex; align-items:center; gap:12px; font-family:'Source Sans 3', system-ui, sans-serif; font-size:11px; letter-spacing:.3em; text-transform:uppercase; color:#465d4e; margin-bottom:18px; }
  ...
  .meta { font-family:'Source Sans 3', system-ui, sans-serif; font-size:11px; letter-spacing:.28em; text-transform:uppercase; color:rgba(42,42,38,.6); line-height:2.1; text-align:right; }
  ...
  nav.tabs a { font-family:'Source Sans 3', system-ui, sans-serif; font-size:11px; letter-spacing:.24em; text-transform:uppercase; text-decoration:none;
  ...
  .sect-line { display:flex; align-items:center; gap:18px; margin-bottom:28px; font-family:'Source Sans 3', system-ui, sans-serif; font-size:11px; letter-spacing:.26em; text-transform:uppercase; color:rgba(42,42,38,.55); }
  ...
  .meta-row .n { font-family:'Source Sans 3', system-ui, sans-serif; font-size:10px; letter-spacing:.26em; text-transform:uppercase; color:rgba(42,42,38,.55); flex:none; }
  .badge { position:absolute; top:14px; right:14px; z-index:2; font-family:'Source Sans 3', system-ui, sans-serif; font-size:10px; letter-spacing:.2em;
  ...
  footer.legal .mono { font-family:'Source Sans 3', system-ui, sans-serif; font-size:10px; letter-spacing:.28em; text-transform:uppercase; color:#465d4e; }
</style>
</head>
<body>
